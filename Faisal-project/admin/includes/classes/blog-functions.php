...
class blog_functions
{
	...
	?>
		...
		<script type="text/javascript" src="jscripts/tiny_mce/js_tinymce.js"></script>
    		...
    		<table cellpadding="0" cellspacing="0" width="100%">
            	<td  valign="top" id="register_section">
                	<div class="page_title">
                        ...
                        <div class="back_btn">
                        	<input type="button" onclick="javascript:window.location='blog-dashboard.php'" value="&lt;&lt;Back" class="b_button" />
                        </div>
                        <div class="clear"></div>
                    </div>                
                    <div class="add_area">
                            ...
                            <tr>
                                ...
                                <td valign="top" align="right" class="category">
                                    <table border="0px" cellpadding="0px" cellspacing="0px" width="100%">
                                        ...
                                        <tr><td class="add_cat_link"><a class="links" href="blog-dashboard.php?tab=add_category" style="">+&nbsp;Add New Category</a></td></tr>
                                    </table>
                                </td>
                            </tr>                           
                        </table>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <tr><td>&nbsp;</td></tr>
                                      ...
                                      while($row=$this->db->fetch_array($result)){
                                      ?>
                                          <tr><td align="left" valign="middle" bgcolor="#666666" style="color:#FFF; padding:2px; padding:1px 6px; font-size:13px;"><div style="float:left"><?php echo ucwords($row['name'])?></div><div style="float:right"><a class="links" href="#" onclick="editCat('<?php echo $row['serial']?>','<?php echo $row['name']?>')" style="color:#FFF;">Edit</a> / <a class="links" href="#" onclick="deleteCat('<?php echo $row['serial']?>')" style="color:#FFF;">Delete</a></div></td></tr>
                                          <tr>
                                            <td style="padding-left:15px; background-color:#FFF; border:1px solid #CCC; ">
                                                <table border="0px" cellpadding="3px" cellspacing="0px" width="100%">
                                                  ...
                                                  <td align="right" style="font-size:13px;" ><a class="links" href="#" onclick="editSubcat('<?php echo $row1['serial']?>','<?php echo $row1['name']?>')">Edit</a> / <a class="links" href="#" onclick="deleteSubcat('<?php echo $row1['serial']?>')">Delete</a></td></tr>
                                                  <?php }?>
                                                </table>
                                            </td>
                                          </tr>
            ...
            <table cellpadding="0" cellspacing="0" width="100%">
                <td  valign="top" id="register_section">
                    <div class="page_title">
                        <div class="heading"><?php echo $page_title?></div>
                        <div class="back_btn">                           
                            <input type="button" onclick="javascript:window.location='blog-dashboard.php?tab=add_post'" value="+&nbsp;New Post" class="b_button" />
                        </div>
                        <div class="back_btn">                           
							<input type="button" onclick="javascript:window.location='blog-dashboard.php?tab=check_comments'" value="Comments" class="b_button" />
                        </div>
                        <div class="clear"></div>
                    </div>                
                    <div class="add_area">
                        ...
                        <table border="0px" cellpadding="3px" cellspacing="0px" width="100%">
                            ...
                            <?php }?>
                            <?php if($i==0){?>
                            <tr><td style="padding:3px;" align="center" valign="middle"><span style="font-family:Arial, Helvetica, sans-serif; font-size:14px; color:#F00; font-weight:bold;">No Post Exist. Click <a class="links" href="add-blog-post.php">here</a> to create new post.</span><br /><br /><br /><br /></td></tr>
                            <?php }?>                           
                        </table>
                        </form>
                    </div>
