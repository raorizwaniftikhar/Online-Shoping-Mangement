<?php
	...
	$sub_cat_id=intval($_REQUEST['sub_cat_id']);
	if($id<=0 && $sub_cat_id<=0 && $_REQUEST['searchbar']==""){
		header("location: index.php");
		exit();
	}
	if($_REQUEST['searchbar']!=""){
		$where.=" and title like '%".$_REQUEST['searchbar']."%' ";
	}
?>
            ...
            <div id="centercontainer" >
                   <div ><?php echo $msg; ?></div>
                   	<?php
						...
						$query="select * from products where locked='no' ".$where;
						$results_per_page=9;
