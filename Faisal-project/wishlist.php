<?php
	...
	include("includes/classes/cart.php");include("includes/classes/preferences.php");
	...
	if ($_REQUEST['command']=='delete'){
		$id=$_REQUEST['id'];
		$r=$db->query("delete from orders where id=".$id);
		if($r){
			$ms=$db->query("delete from order_detail where order_id=".$id);
                                        ...
                                        <td valign="top">
                                            <table border="1" style="border-collapse:collapse" width="650px" cellpadding="3px">
                                                <tr bgcolor="#666666" style="color:#FFF">
                                                	<td width="20px">&nbsp;</td><td>Order Date</td><td align="center">Amount</td><td align="center">Options</td>
                                                </tr>
                                                <?php
                                                    $result=$db->query("select * from orders ".$where." and order_type='wish' and member_id=".$a->get_id()." order by id desc");
                                                    $count=1;
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td align="center">
                                                        	<a href="wish-detail.php?id=<?php echo $row['id'];?>">Detail</a> | 
                                                            <a href="?command=delete&id=<?php echo $row['id'];?>">Delete</a>
                                                        </td>
                                                    </tr>
                                                <?php
                                                    }
